...
from src.agentes.memoria.historial import MemoriaConexionError, crear_memoria_usuario, normalizar_session_id_postgres_langchain
from src.api.configuracion import obtener_configuracion
from src.api.dependencias import obtener_grafo_agente, obtener_usuario_actual
...
async def _generador_eventos_sse(
    ...
    texto_acumulado = ""
    modelo_etiqueta = cfg.router_llm_model
...
@router.post(
    ...
    responses={
        ...
        503: {"description": "Grafo del agente no disponible (configuracion o dependencias)."},
    },
)
async def agente_stream(
    ...
    return EventSourceResponse(
        _generador_eventos_sse(request, grafo, peticion, usuario),
        ping=_KEEPALIVE_SEG,
    )
