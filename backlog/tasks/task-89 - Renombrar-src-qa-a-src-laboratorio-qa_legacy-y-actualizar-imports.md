...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 El codigo fuente de qa_legacy vive bajo src/laboratorio/qa_legacy/ con __init__.py y modulos migrados.
- [ ] #2 tests/qa y scripts que importaban src.qa actualizan imports al nuevo paquete.
- [ ] #3 Opcional documentado: shim src/qa/__init__.py con DeprecationWarning y reexport limitado durante periodo de gracia (si el equipo lo elige).
- [ ] #4 `rg "from src\\.qa\\."` solo encuentra el shim (si existe) o cero resultados.
- [ ] #5 README.md actualizado: ruta nueva y rol de laboratorio; coherente con task-88.
- [ ] #6 `uv run pytest tests/qa` (y suite relacionada) verde.
<!-- AC:END -->
...
## Definition of Done
<!-- DOD:BEGIN -->
- [ ] #1 Done sin task_complete.
- [ ] #2 CHANGELOG o nota en PR si el equipo lo exige; si no, README basta.
<!-- DOD:END -->
