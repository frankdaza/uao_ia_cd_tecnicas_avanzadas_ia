...
Este directorio (`proyecto-1/`) es el **proyecto ejecutable** del curso. El corpus compartido está en [`../data/`](../data/); backlog y documentación del curso en [`../backlog/`](../backlog/). Índice del workspace: [`../README.md`](../README.md).
...
| [`../data/raw/`](../data/raw/), [`../data/markdown/`](../data/markdown/), [`../data/structured/`](../data/structured/) | Crudo, corpus canónico, FAQs JSON (workspace compartido). |
...
Desde **`proyecto-1/`** (este directorio):

```bash
cd proyecto-1   # si aún no estás aquí
uv run pytest
```
