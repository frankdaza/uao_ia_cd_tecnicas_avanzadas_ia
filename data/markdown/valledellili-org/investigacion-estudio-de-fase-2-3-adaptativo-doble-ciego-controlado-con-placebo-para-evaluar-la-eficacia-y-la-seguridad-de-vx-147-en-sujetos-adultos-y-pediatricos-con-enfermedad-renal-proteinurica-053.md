---
source_url: https://valledellili.org/investigacion/estudio-de-fase-2-3-adaptativo-doble-ciego-controlado-con-placebo-para-evaluar-la-eficacia-y-la-seguridad-de-vx-147-en-sujetos-adultos-y-pediatricos-con-enfermedad-renal-proteinurica-053/
titulo: Estudio de fase 2/3, adaptativo, doble ciego, controlado con placebo, para
...
idioma: es
hash: 06b69d66cf5c6ddd20a96b6a6bc5fb8c0c4445a5e3820748af0e1de4dade02a0
---
...
ID del estudio: 05312879

Estudio de fase 2/3 adaptativo, doble ciego y controlado con placebo para evaluar la eficacia y seguridad de VX-147 en sujetos adultos y pediátricos con enfermedad renal proteinúrica mediada por APOL1.

## **Sobre el estudio:**

Este estudio se realiza para obtener más información sobre la seguridad y la eficacia del fármaco en fase de investigación VX-147 (inaxaplina) en participantes con enfermedad renal crónica (ERC) mediada por APOL1. Las personas de ascendencia africana reciente tienen más probabilidades de presentar ciertas variaciones en el gen APOL1 y corren un mayor riesgo de desarrollar ERC. En la actualidad, el tratamiento para la ERC solo existe para controlar algunos aspectos de la enfermedad, como la presión arterial alta. Sin embargo, también es importante tratar el empeoramiento de la función renal, así como la causa subyacente de la ERC. El VX-147 (inaxaplina) se está estudiando para determinar si puede volver más lento o detener el empeoramiento de la función renal, así como dirigirse a la causa subyacente de esta enfermedad. El VX-147 (inaxaplina) es un fármaco en fase de investigación, significa que el fármaco no está aprobado por el Instituto Nacional de Vigilancia de Medicamentos y Alimentos (INVIMA) ni por las autoridades sanitarias de otros países y aún se está evaluando para determinar su seguridad y efectividad.

---

![](https://valledellili.org/wp-content/themes/vstheme/assets/img/icons/clock.svg)
Duración total

![](https://valledellili.org/wp-content/themes/vstheme/assets/img/icons/icon-people.svg)
Público objetivo

Edades: 10 Años - 65 Años  
Sexo: Todos

![](https://valledellili.org/wp-content/themes/vstheme/assets/img/icons/icon-location-flaten-accent.svg)
Ubicación
...
![](https://valledellili.org/wp-content/themes/vstheme/assets/img/icons/icono-reclutando.png)
...
![](https://valledellili.org/wp-content/themes/vstheme/assets/img/icons/icon-phone-accent.svg)
