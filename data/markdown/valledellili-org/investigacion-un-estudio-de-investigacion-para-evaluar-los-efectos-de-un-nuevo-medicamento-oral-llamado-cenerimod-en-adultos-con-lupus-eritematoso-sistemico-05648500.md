---
source_url: https://valledellili.org/investigacion/un-estudio-de-investigacion-para-evaluar-los-efectos-de-un-nuevo-medicamento-oral-llamado-cenerimod-en-adultos-con-lupus-eritematoso-sistemico-05648500/
titulo: Un estudio de investigación para evaluar los efectos de un nuevo medicamento
...
idioma: es
hash: da1790e97b721e3d934903c01c3fe1ec962dff98e154b44443c7b55564d039b1
---
...
ID del estudio: 05648500

Estudio de fase 3, multicéntrico, aleatorizado, doble ciego, en grupos paralelos y controlado con placebo, para evaluar la eficacia, seguridad y tolerabilidad de cenerimod en sujetos adultos con lupus eritematoso sistémico (LES) de moderado a severo además del tratamiento de base

## **Sobre el estudio:**

El propósito del estudio es conocer el efecto del medicamento del estudio (cenerimod) sobre el tratamiento y la reducción de los síntomas del Lupus eritematoso sistémico cuando se administra a pacientes adultos con síntomas de moderados a graves. El objetivo también es averiguar qué tan seguro es cenerimod para pacientes adultos con Lupus eritematoso sistémico. Cenerimod es un nuevo medicamento que puede reducir la cantidad de ciertos glóbulos blancos que están involucrados en el Lupus. Al hacerlo, puede ayudar a reducir la inflamación en su cuerpo y mejorar sus sintomas. En este estudio se prueba una dosis de cenerimod en comparación con un placebo. Es importante comparar cenerimod con un placebo para saber si cenerimod es realmente efectivo. Recibirá cenerimod o el placebo además del medicamento que está administrando actualmente para tratar su Lupus.
