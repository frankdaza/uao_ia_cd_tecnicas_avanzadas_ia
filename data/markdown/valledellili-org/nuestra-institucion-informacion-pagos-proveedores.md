---
source_url: https://valledellili.org/nuestra-institucion/informacion-pagos-proveedores/
titulo: Información proceso de pagos para proveedores de FVL
seccion: nuestra-institucion
fecha_extraccion: '2026-04-26'
idioma: es
hash: aa6dcc41be88af8d91f3a80bf54f9c2d93181d58473853251d156f729f461041
---
...
## Estimado proveedor, las siguientes recomendaciones aseguran la radicación de su factura electrónica y el pago oportuno.

---

![calculadora (1)](https://valledellili.org/wp-content/uploads/2023/09/calculadora-1.png "calculadora (1)")

### Antes de Generar su factura, tenga presente:

- Número de la **orden de compra** digitada en el campo **order reference**.
- **Nombre de contacto** en la Fundación Valle del Lili.
- **Servicios de obras:** Acta de avance de obra / **Otros servicios:** Acta de prestación del servicio legible y debidamente firmada por el supervisor.
- **Bienes y productos:** número de la entrada de la mercancía.

![codigo-de-barras](https://valledellili.org/wp-content/uploads/2023/09/codigo-de-barras.png "codigo-de-barras")

### Para Enviar su factura, confirme:

- Que el valor facturado **coincide con el valor de la orden de compra.**
- Que las facturas estén emitidas a nombre de la **Fundación Valle del Lili, NIT 890324177-5**
- Que contenga el **número de la entrada** del servicio y/o de la mercancía.
- Que contenga el **acta de avance de obra** o la aceptación del servicio.

![libre-de-impuestos](https://valledellili.org/wp-content/uploads/2023/09/libre-de-impuestos.png "libre-de-impuestos")

### Para Radicar su factura, recuerde:

- **El único buzón válido** para la recepción de facturas y notas electrónicas de la Fundación Valle del Lili es: factura\_electronica@fvl.org.co
- Es indispensable **adjuntar el documento XML y PDF** de la factura.
...
- La transmisión exitosa realizada ante la DIAN, **NO garantiza la aceptación por parte de la Fundación Valle del Lili.**
...
- **Solicite la asignación de su usuario indicando el nombre de la entidad y NIT al correo: cuentasporpagar.ep@fvl.org.co**
- **Ingrese a nuestro portal de Proveedores de la Fundación Valle del Lili,** a través del cual puede consultar y validar el registro de las facturas y notas emitidas, visualizar los pagos realizados y descargar los certificados requeridos.
- Para mayor información, por favor comuníquese al correo: **sandra.cuellar@fvl.org.co**
