---
source_url: https://valledellili.org/eventos/xxiii-congreso-de-medicina-interna-del-razonamiento-a-la-decision-clinica/
...
[Fundación Valle del Lili](https://valledellili.org "Go to Fundación Valle del Lili.")→[Eventos](https://valledellili.org/eventos/ "Go to Eventos.")→[XXIII Congreso de Medicina Interna – Del razonamiento a la decisión clínica](https://valledellili.org/eventos/xxiii-congreso-de-medicina-interna-del-razonamiento-a-la-decision-clinica/ "Go to XXIII Congreso de Medicina Interna – Del razonamiento a la decisión clínica.")
...
Más que un congreso, una experiencia de transformación profesional.

• **Ciencia con propósito:** Actualización basada en evidencia para retos del mundo real.  
• **Aprendizaje interactivo:** Discusión de casos, debates y espacios reflexivos que desafían el pensamiento convencional.  
• **Excelencia sin fronteras:** El punto de encuentro entre residentes, especialistas e instituciones de prestigio mundial.

**¿Listo para la práctica?**

Nuestros talleres prácticos están diseñados para perfeccionar sus habilidades técnicas con guía experta personalizada.
...
#### Taller: Vacunación en el paciente adulto sano y en situaciones especiales

---

#### Taller. Enfoque del paciente critico: Desde urgencias hasta la UCI
...
[¡Inscríbete aquí!](https://events.peewah.co/xxiii-congreso-de-medicina-interna-2026)
